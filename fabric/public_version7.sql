--CREATE MASTER TABLE
drop table if exists fabric.master7;

create table fabric.master7 as
...
select fiber, count(*)
from fabric.master7, analysis.cai_dec2013
where cai_dec2013.caiid = master7.ncessch
	and lstate = 'AK'
group by fiber;
...
update fabric.master7
	...
	from new_values
	where new_values.caiid=master7.ncessch;

select seasch, caiid, lstate, statecode, fiber
from fabric.master7, analysis.cai_dec2013
where cai_dec2013.caiid = master7.seasch
...
update fabric.master7
	...
	from new_values
	where new_values.caiid=master7.seasch
		and statecode=lstate;

select stid, caiid, lstate, statecode fiber
from fabric.master7, analysis.cai_dec2013
where cai_dec2013.caiid = master7.stid
	and statecode = lstate;
...
update fabric.master7
	...
	from new_values
	where new_values.caiid=master7.stid
		and statecode = lstate;
...
select st_cd, cds_code, fiber
	from fabric.master7, fabric.cenic
	where master7.st_cd = cds_code
	and lstate = 'CA';
...
update fabric.master7
	...
	from new_values
	where new_values.cds_code=master7.st_cd
		and lstate = 'CA';
...
update fabric.master7
	...
	from new_values
	where master7.scd_fl=new_values.school_code
		and lstate = 'FL';
...
update fabric.master7
	...
	from new_values
	where master7.seasch=new_values.wv_school_id
		and lstate = 'WV';
...
update fabric.master7
	...
	from new_values
	where master7.ncessch=new_values.nces_id
		and lstate = 'NM';
...
update fabric.master7
	...
	from new_values
	where master7.schnam = upper(new_values.school_name)
		and master7.leanm = upper(new_values.district_name)
		and lstate = 'MT';
...
select sunesys.rev_appname, leanm, appstate, lstate
	from fabric.sunesys, fabric.master7
...
update fabric.master7
	...
	from new_values
	where master7.schnam = upper(new_values.building_name)
	and master7.lcity = upper(new_values.building_city)
	and master7.lstate = 'OH';
...
from new_values
where master7.seasch = new_values.school_code;
...
update fabric.master7
	...
	from new_values
	where new_values.nces_id=master7.ncessch;
