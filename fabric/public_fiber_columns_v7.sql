...
--Iowa
select *
from fabric.ia_ind, fabric.master4
where ia_ind.state_school_id = seasch
...
--Ritter
select *
from fabric.ritter, fabric.master4
...
update fabric.ms_ind
set fiber = 9
where connection_tech = 'Fiber';
update fabric.ms_ind
set fiber = -9
where connection_tech = 'Cable' or connection_tech = 'T-1' or connection_tech = 'Wireless';
update fabric.ms_ind
set fiber = 0
